...
const FoerdervereinForm: React.FC = () => {
  return (
    <div className="pt-32 pb-24 bg-[#f8f9f5] min-h-screen">
      <div className="container mx-auto px-6">
        <header className="mb-20 text-center max-w-4xl mx-auto animate-fadeInUp">
          <span className="text-[#7cb342] font-black text-xs uppercase tracking-[0.4em] mb-4 block">Gemeinsam für die Kultur</span>
          <h1 className="text-5xl md:text-7xl font-display text-[#1d3a28] mb-8 leading-tight">Antrag <br /><span className="italic font-normal">Förderverein.</span></h1>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[60px] p-12 md:p-20 shadow-xl border border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-display text-[#1d3a28] mb-6">Mitgliedschaft im Förderverein</h2>
              <div className="space-y-6">
                {[
                  { title: "Kulturförderung", desc: "Unterstützen Sie ein preisgekröntes Programmkino." },
                  { title: "Technik-Investitionen", desc: "Helfen Sie uns, modernste Projektionstechnik zu finanzieren." },
                  { title: "Gemeinschaft", desc: "Werden Sie Teil eines Netzwerks von Filmbegeisterten." }
                ].map((item, i) => (
              ...
              <div className="mt-12 p-8 bg-[#f8f9f5] rounded-3xl border border-gray-100">
                <p className="text-sm text-gray-600 italic">
                  "Der Förderverein ist ein wichtiger Stützpfeiler für den Stadtjugendring Urach e.V. и ermöglicht Investitionen, die über den regulären Betrieb hinausgehen."
                </p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="mt-8 text-xs text-gray-400 uppercase tracking-widest font-bold">
                Antrag_Foerderverein.pdf · 520 KB
              </p>
            </div>
          </div>
        </div>
...
export default FoerdervereinForm;
