    ...
    <div className="pt-32 pb-24 bg-[#f8f9f5]">
      <div className="container mx-auto px-6">
        <header className="mb-20 text-center max-w-4xl mx-auto animate-fadeInUp">
          <span className="text-[#7cb342] font-black text-xs uppercase tracking-[0.4em] mb-4 block">Unsere Wurzeln</span>
          <h1 className="text-5xl md:text-7xl font-display text-[#1d3a28] mb-8 leading-tight">Stadtjugendring <br /><span className="italic font-normal">Urach e.V.</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-32 items-center">
          <div className="animate-fadeInLeft">
            <h2 className="text-3xl font-display text-[#1d3a28] mb-6">Geschichte & Entstehung</h2>
        ...
        <div className="bg-[#1d3a28] rounded-[60px] p-12 md:p-24 text-white relative overflow-hidden mb-32">
          <div className="absolute top-0 right-0 w-1/2 h-full bg-[#7cb342]/5 -skew-x-12 translate-x-1/4" />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl md:text-5xl font-display mb-8 leading-tight">Unsere <br /><span className="italic font-normal text-[#7cb342]">Philosophie.</span></h2>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-6">
                    <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center shrink-0 text-[#7cb342]">✓</div>
                    <div>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[40px] p-10 border border-white/10">
              ...
              <div className="p-6 bg-[#7cb342]/20 rounded-2xl border border-[#7cb342]/30">
                <p className="italic text-sm text-[#a2d149]">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-display text-[#1d3a28] mb-8">Unterstützen Sie uns</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <a href="#/service/prices" className="bg-[#7cb342] text-white px-10 py-4 rounded-full font-bold hover:shadow-xl transition-all">Patenschaft & Förderung</a>
            <a href="#/about/jobs" className="bg-[#1d3a28] text-white px-10 py-4 rounded-full font-bold hover:shadow-xl transition-all">Ehrenamtlich mitwirken</a>
          </div>
        </div>
      </div>
    </div>
